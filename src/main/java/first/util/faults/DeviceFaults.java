...
public class DeviceFaults implements StructSerializable {
	...
	public static enum FaultType {
		...
		public boolean getFaultFrom(SparkMax sparkMax) {
			return switch (this) {
				case CAN -> sparkMax.getFaults().get().can;
				case EscEepromFault -> sparkMax.getFaults().get().escEeprom;
				case EscEepromWarning -> sparkMax.getWarnings().get().escEeprom;
				case ExtEeprom -> sparkMax.getWarnings().get().extEeprom;
				case GateDriver -> sparkMax.getFaults().get().gateDriver;
				case Hardware -> sparkMax.getFaults().get().firmware;
				case HasReset -> sparkMax.getWarnings().get().hasReset;
				case MotorType -> sparkMax.getFaults().get().motorType;
				case Overcurrent -> sparkMax.getWarnings().get().overcurrent;
				case SensorFault -> sparkMax.getFaults().get().sensor;
				case SensorWarning -> sparkMax.getWarnings().get().sensor;
				case Stall -> sparkMax.getWarnings().get().stall;
				case Temperature -> sparkMax.getFaults().get().temperature;
				case Undervoltage -> sparkMax.getWarnings().get().brownout;
				case UnknownFault -> sparkMax.getFaults().get().other;
				case UnknownWarning -> sparkMax.getWarnings().get().other;
				default -> false;
			};
		}
		public boolean getStickyFaultFrom(SparkMax sparkMax) {
			return switch (this) {
				case CAN -> sparkMax.getStickyFaults().get().can;
				case EscEepromFault -> sparkMax.getStickyFaults().get().escEeprom;
				case EscEepromWarning -> sparkMax.getStickyWarnings().get().escEeprom;
				case ExtEeprom -> sparkMax.getStickyWarnings().get().extEeprom;
				case GateDriver -> sparkMax.getStickyFaults().get().gateDriver;
				case Hardware -> sparkMax.getStickyFaults().get().firmware;
				case HasReset -> sparkMax.getStickyWarnings().get().hasReset;
				case MotorType -> sparkMax.getStickyFaults().get().motorType;
				case Overcurrent -> sparkMax.getStickyWarnings().get().overcurrent;
				case SensorFault -> sparkMax.getStickyFaults().get().sensor;
				case SensorWarning -> sparkMax.getStickyWarnings().get().sensor;
				case Stall -> sparkMax.getStickyWarnings().get().stall;
				case Temperature -> sparkMax.getStickyFaults().get().temperature;
				case Undervoltage -> sparkMax.getStickyWarnings().get().brownout;
				case UnknownFault -> sparkMax.getStickyFaults().get().other;
				case UnknownWarning -> sparkMax.getStickyWarnings().get().other;
				default -> false;
			};
		}
	}
