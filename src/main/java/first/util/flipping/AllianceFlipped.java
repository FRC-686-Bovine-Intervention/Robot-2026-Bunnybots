...
public class AllianceFlipped<T> {
	...
	public static AllianceFlipped<ChassisVelocities> fromBlue(ChassisVelocities blue) {
		return AllianceFlipped.fromBlue(blue, AllianceFlipUtil.defaultFlipType);
	}
	public static AllianceFlipped<ChassisVelocities> fromBlue(ChassisVelocities blue, FieldFlipType flipType) {
		return new AllianceFlipped<>(blue, AllianceFlipUtil.flipFieldRelative(blue, flipType));
	}
	public static AllianceFlipped<ChassisVelocities> fromRed(ChassisVelocities red) {
		return AllianceFlipped.fromRed(red, AllianceFlipUtil.defaultFlipType);
	}
	public static AllianceFlipped<ChassisVelocities> fromRed(ChassisVelocities red, FieldFlipType flipType) {
