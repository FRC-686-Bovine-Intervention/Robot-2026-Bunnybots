...
import first.util.led.strips.adapters.ConcatenatedStrip;
import first.util.led.strips.adapters.ParallelStrip;
import first.util.led.strips.adapters.ReversedStrip;
import first.util.led.strips.adapters.SubStrip;
...
public interface LEDStrip {
	...
	public default void clear() {
		this.foreach((int i) -> this.setLED(i, Color.BLACK));
	}
